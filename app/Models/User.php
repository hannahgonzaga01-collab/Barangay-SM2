...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'contact_number', 'birthday', 'birthplace', 'gender',
        'civil_status', 'spouse_name',
        'address', 'occupation', 'photo',
        'resident_code', 'is_voter', 'is_senior', 'is_pwd',
        'is_single_parent', 'is_student',
        'security_question', 'security_answer', 'password_history'
    ];
