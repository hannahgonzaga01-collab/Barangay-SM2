            ...
            <form action="{{ route('office.store') }}" method="POST" enctype="multipart/form-data" style="padding-top:14px;" 
                ...
                <div class="fgrp">
                    ...
                    <div x-show="isHouseholdHead" x-transition style="margin-top:12px;background:#f8fafc;padding:14px;border-radius:11px;border:1px solid var(--border);overflow-x:auto;">
                        ...
                        <button type="button" @click="familyMembers.push({first_name:'',middle_name:'',last_name:'',suffix:'',relationship:'',birthday:'',age:'',gender:'Male',civil_status:'Single',classification:''})" class="btn-plain btn-edit" style="font-size:9px;margin-top:6px;"><i class="fas fa-plus"></i> Add Family Member</button>
                    </div>
                </div>
