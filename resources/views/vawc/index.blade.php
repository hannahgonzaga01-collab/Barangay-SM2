    ...
    <div class="portal-wrap" x-data="{
        ...
        exportVawcReportPdf() {
            ...
            if (typeof html2pdf !== 'undefined') {
                const opt = {
                    margin: [6, 6, 6, 6],
                    filename: 'VAWC_Monthly_Compliance_Report_' + (this.vawcRep?.monthYear || 'Report').replace(/[^a-zA-Z0-9_-]/g, '_') + '.pdf',
            ...
            <div class="card">
                <div class="card-head">
                    ...
                    <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                        ...
                        <button type="button" @click="exportVawcReportPdf()" class="btn btn-ghost btn-sm" style="display:inline-flex;align-items:center;gap:6px;background:#f0fdf4;color:#166534;border:1px solid #bbf7d0;font-weight:800;">
